...
public class SweepUtilGenericTest extends AbstractTest {
    ...
    public void sweepPreview_hex() throws Exception {
        ...
        assertSweepPreview(sweepPreview, "2Mu3RYBxGdkz8rwCaYZWhi24A4aR1cSWJFb", BIP_FORMAT.SEGWIT_COMPAT,135, 1, new BigInteger("2854445280755403823944422649848886010716442579975080723501674454330739189892"));

        sweepPreview = it.next();
        assertSweepPreview(sweepPreview, "tb1qkz6870gwrtp4unx9yw4qvz27tagd5wykynufyq", BIP_FORMAT.SEGWIT_NATIVE, 112, 1, new BigInteger("2854445280755403823944422649848886010716442579975080723501674454330739189892"));
    }
