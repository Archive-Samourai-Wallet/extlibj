...
public class SpendBuilderTest extends AbstractTest {
    ...
    public void simpleSpend_single_bip84() throws Exception {
        ...
        verifySpendTx(spendTx, SpendType.SIMPLE, Arrays.asList(utxo2), 154, amount, changeExpected, BIP_FORMAT.SEGWIT_NATIVE,
                outputs,
    ...
    public void simpleSpend_single_bip49() throws Exception {
        ...
        verifySpendTx(spendTx, SpendType.SIMPLE, Arrays.asList(utxo2), 154, amount, changeExpected, BIP_FORMAT.SEGWIT_COMPAT,
                outputs,
    ...
    public void simpleSpend_2utxos() throws Exception {
        ...
        outputs.put(ADDRESS_BIP84, amount);
        outputs.put(ADDRESS_CHANGE_84[0], changeExpected);
        verifySpendTx(spendTx, SpendType.SIMPLE, Arrays.asList(utxo3, utxo2), 226, amount, changeExpected, BIP_FORMAT.SEGWIT_NATIVE,
                outputs,
    ...
    public void simpleSpend_3utxos() throws Exception {
        ...
        outputs.put(ADDRESS_BIP84, amount);
        outputs.put(ADDRESS_CHANGE_84[0], changeExpected);
        verifySpendTx(spendTx, SpendType.SIMPLE, Arrays.asList(utxo3, utxo2, utxo1), 299, amount, changeExpected, BIP_FORMAT.SEGWIT_NATIVE,
                outputs,
    ...
    public void stonewall_bip84() throws Exception {
        ...
        verifySpendTx(spendTx, SpendType.STONEWALL, Arrays.asList(utxo3, utxo4, utxo2, utxo5, utxo6), 516, amount, 69484, BIP_FORMAT.SEGWIT_NATIVE,
                outputs,
    ...
    public void stonewall_bip49() throws Exception {
        ...
        verifySpendTx(spendTx, SpendType.STONEWALL, Arrays.asList(utxo3, utxo4, utxo2, utxo5, utxo6), 516, amount, 69484, BIP_FORMAT.SEGWIT_COMPAT,
                outputs,
    ...
    public void stonewall_bip44() throws Exception {
        ...
        outputs.put(ADDRESS_CHANGE_84[0], 9742L);
        outputs.put(ADDRESS_CHANGE_84[1], 19742L);
        verifySpendTx(spendTx, SpendType.STONEWALL, Arrays.asList(utxo3, utxo4, utxo2, utxo5, utxo6), 516, amount, 69484, BIP_FORMAT.LEGACY,
                outputs,
    ...
    private void verifySpendTx(SpendTx spendTx, SpendType spendType, Collection<UTXO> utxos, long fee, long amount, long change, BipFormat changeFormat, Map<String,Long> outputsExpected, String txid, String raw) throws Exception {
        verifySpendTx(spendTx, spendType, utxos, fee, amount, change, changeFormat);
