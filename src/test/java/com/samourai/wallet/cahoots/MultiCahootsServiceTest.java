...
import com.samourai.wallet.cahoots.multi.MultiCahootsResult;
...
public class MultiCahootsServiceTest extends AbstractCahootsTest {
    ...
    public void multiCahoots_bip84() throws Exception {
        ...
        MultiCahootsResult cahootsResult = (MultiCahootsResult)doCahoots(multiCahootsService, contextSender, contextCp, null);
        MultiCahoots cahoots = cahootsResult.getCahoots();

        // verify stonewallx2
        {
            Transaction tx = cahoots.getStonewallTransaction();
        ...
        // verify stowaway
        {
            Transaction tx = cahoots.getStowawayTransaction();
        ...
        SpendTx spendTx = cahoots.getStonewallx2().getSpendTx(contextSender.getStonewallx2Context(), utxoProviderSender);
        verifySpendTx(spendTx, SpendType.CAHOOTS_STONEWALL2X, Arrays.asList(utxoSender1), 272, 136, 0, spendAmount, false, 4864L);
    }
