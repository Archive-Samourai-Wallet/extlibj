...
public abstract class AbstractCahootsTest extends AbstractTest {
    ...
    public void setUp() throws Exception {
        ...
        cahootsWalletSender = new CahootsWallet(walletSupplierSender, mockChainSupplier, bipFormatSupplier, utxoProviderSender.getCahootsUtxoProvider(), cryptoUtil);
        ...
        cahootsWalletCounterparty = new CahootsWallet(walletSupplierCounterparty, mockChainSupplier, bipFormatSupplier, utxoProviderCounterparty.getCahootsUtxoProvider(), cryptoUtil);
