...
public class Stonewallx2ServiceTest extends AbstractCahootsTest {
    ...
    public void STONEWALLx2_BIP84() throws Exception {
        ...
        CahootsResult cahootsResult = doCahoots(stonewallx2Service, cahootsContextSender, cahootsContextCp, null);
        STONEWALLx2 cahoots = (STONEWALLx2)cahootsResult.getCahoots();
        ...
        verifySpendTx(spendTx, SpendType.CAHOOTS_STONEWALL2X, Arrays.asList(utxoSender1), 272, 136, 0, spendAmount, false, 4864);
    }
