...
public class TaprootRedeemScriptTests {
    ...
    @Test
    public void redeemScriptTests() throws IOException {
        ...
        SegwitAddress segwitAddress = new SegwitAddress(key, PARAMS);
        Assertions.assertEquals("bc1qxqr6cm2xnmxv09pmmvtxvrg0xhxg7kjg5sv4r6", segwitAddress.getBech32AsString());
        Script taprootRedeemScript0 = segwitAddress.taprootRedeemScript();
        ...
        SegwitAddress taprootAddress = new SegwitAddress(tweakedPrivKey, null);
        Script taprootRedeemScript1 = taprootAddress.taprootRedeemScript();
