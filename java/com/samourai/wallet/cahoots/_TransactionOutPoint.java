...
public class _TransactionOutPoint extends MyTransactionOutPoint {
    ...
    public _TransactionOutPoint(MyTransactionOutPoint outpoint) throws ProtocolException {
        super(outpoint.getParams(), outpoint.getTxHash(), outpoint.getTxOutputN(), BigInteger.valueOf(outpoint.getValue().longValue()), outpoint.getScriptBytes(), outpoint.getAddress());
    }
