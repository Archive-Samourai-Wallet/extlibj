...
public class SamouraiConfig {
    ...
    private Collection<String> sorobanServerDexTestnetClear =
            Arrays.asList(
    ...
    private Collection<String> sorobanServerDexTestnetOnion =
            Arrays.asList(
    ...
    private Collection<String> sorobanServerDexMainnetClear =
            Arrays.asList(
                    ...
                    "http://85.208.69.40:4242");
    private Collection<String> sorobanServerDexMainnetOnion =
            Arrays.asList(
                    ...
                    "http://soieiiyokgrhhahik4uu4a3tfv5zb5xznsonhitny2b47qog4mzypzad.onion");
