...
public enum WALLET_INDEX {
  ...
  POSTMIX_BIP44_RECEIVE(BIP_WALLET.POSTMIX_BIP44, Chain.RECEIVE),
  POSTMIX_BIP44_CHANGE(BIP_WALLET.POSTMIX_BIP44, Chain.CHANGE),

  POSTMIX_BIP49_RECEIVE(BIP_WALLET.POSTMIX_BIP49, Chain.RECEIVE),
  POSTMIX_BIP49_CHANGE(BIP_WALLET.POSTMIX_BIP49, Chain.CHANGE),
